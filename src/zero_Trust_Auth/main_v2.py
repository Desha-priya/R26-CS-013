# main.py  Improved one
# NeuraShield - Zero-Trust Auth Layer
# FastAPI application - Python 3.14 compatible (no Jinja2)
...
KS_AGG_FILE = "user_keystroke_profiles.csv"
ks_agg_df   = None
...
async def enroll_user(req: EnrollRequest):
    ...
    """
    feature_weights = joblib.load("models/feature_weights_v2.pkl") \
        if os.path.exists("models/feature_weights_v2.pkl") else np.ones(len(FEATURE_COLS))
